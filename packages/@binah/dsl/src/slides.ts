 ...
 * had drifted apart before @binah/dsl existed:
 *   - app:      lib/types/slides.ts
 *   - renderer: packages/@binah/renderer/src/types/slides.ts
 *   - importer: packages/@binah/importer/src/binah/types/slides.ts
 *
