 ...
 * document to another runtime. `@binah/renderer` already consumes resolved
 ...
 * future `@binah/exporter` package can build on the same contract.
 *
 ...
 * CDN on a server — live in `@binah/storage`, keeping this package
 ...
 * pure package to the DOM lib. Backends in `@binah/storage` accept a real
