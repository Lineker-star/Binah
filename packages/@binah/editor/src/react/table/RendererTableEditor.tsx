...
import type { PPTTableElement, TableCell, TableCellBorder } from '@binah/dsl';
import { getTableSubThemeColor } from '@binah/renderer';
import { getTextStyle } from '@binah/renderer/elements';
