...
import { useViewportSize } from '@binah/renderer';
import { getLineElementPath } from '@binah/renderer';
...
vi.mock('@binah/renderer', async (importOriginal) => ({
  ...(await importOriginal<typeof import('@binah/renderer')>()),
