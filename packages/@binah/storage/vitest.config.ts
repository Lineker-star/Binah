...
// Resolve `@binah/storage` self-imports and the `@binah/dsl` dependency to
...
export default defineConfig({
  resolve: {
    alias: {
      '@binah/storage': fileURLToPath(new URL('./src/index.ts', import.meta.url)),
      '@binah/dsl': fileURLToPath(new URL('../dsl/src/index.ts', import.meta.url)),
    },
  },
  test: {
