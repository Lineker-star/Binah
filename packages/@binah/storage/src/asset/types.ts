...
export class AssetNotFoundError extends Error {
  ...
  constructor(message = '@binah/storage: no asset is stored under that id') {
    super(message);
...
export class AssetQuotaExceededError extends Error {
  ...
  constructor(message = '@binah/storage: asset quota exceeded for this principal') {
    super(message);
 ...
 * descriptor.
 */
export const ASSET_DESCRIPTOR_MEDIA_TYPE = 'application/vnd.binah.asset-descriptor+json';
