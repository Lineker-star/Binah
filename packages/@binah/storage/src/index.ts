/**
 * @binah/storage — the MAIC pluggable persistence layer.
 *
 * Dependency arrow (kept acyclic): `@binah/storage -> @binah/dsl` only.
...
export type { AssetRef, AssetMeta, BinaryBlob, StorageProvider } from '@binah/dsl';
