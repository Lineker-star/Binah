...
13. **Course mode — practical vs. theoretical balance**: As a strong default, aim for roughly 70% practical/applied content and 30% theoretical explanation across this lesson's scenes — favor real-world scenarios, worked examples, and "how would you use this" framing over abstract exposition. This is a default, not a hard rule: when the subject genuinely doesn't support it (e.g. a pure math proof, a foundational-definitions lesson that later lessons will build on), let the subject matter override the ratio rather than forcing artificial scenarios onto it.
{{/if}}
