...
description: Run Binah locally in five minutes.
---

Binah is a Next.js application that runs on your own machine. You need to configure at least one LLM provider: cloud providers usually require an API key, while local Ollama or Lemonade does not.
...
- For architecture details or contribution guidance, visit [GitHub](https://github.com/Lineker-star/binah#-contributing)
