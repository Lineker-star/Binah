...
export const metadata: Metadata = {
  title: 'BINAH — The Intelligent Classroom',
  description:
    'Binah, the open-source AI interactive classroom. Upload a PDF to instantly generate an immersive, multi-agent learning experience.',
};
